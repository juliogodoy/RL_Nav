...
class RVOEnv():
    ...
    def __init__(self):
        ...
        self.a0 = sim.addAgent((10, -15))
        self.a1 = sim.addAgent((10, 8), 15, 10, 5, 1.3, 0.4, 1.5, (0, 0))
        ...
        self.o1 = sim.addObstacle([(8.0, 9.0), (-8.0, 9.0), (-8.0, 8.42),(8.0, 8.42)])
        self.o2 = sim.addObstacle([(8.0, 7.58), (-8.0, 7.58), (-8.0, 7.0),(8.0, 7.0)])
    ...
    def step(self, action):
        ...
        obstacle0_relative_p= np.array([8.0, 9.0])-np.array(agent_own_p)
        obstacle1_relative_p= np.array([-8.0, 9.0])-np.array(agent_own_p)
        ...
        obstacle6_relative_p= np.array([-8.0, 7.0])-np.array(agent_own_p)
        obstacle7_relative_p= np.array([8.0, 7.0])-np.array(agent_own_p)
        ...
        done = (np.linalg.norm(np.array([10,8])- np.array(sim.getAgentPosition(0))) < 1)# and (np.linalg.norm(np.array([-10,8])- np.array(sim.getAgentPosition(1))) < 1)
        #print("Done is ", done)
    ...
    def reset(self):
        ...
        sim.setAgentPosition(0, (9+initialPosProbX*5,initialPosProbY*15))
