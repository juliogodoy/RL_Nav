...
def showScreen():
    ...
    for step in range(2000):
        ...
        GoalVector_a0 = np.array([10,28])-np.array(sim.getAgentPosition(a0))
        unitario_a0 = unit_vector(GoalVector_a0)
        sim.setAgentPrefVelocity(a0, (unitario_a0[0]+dist_0*math.cos(angle_0), unitario_a0[1]+dist_0*math.sin(angle_0)))
